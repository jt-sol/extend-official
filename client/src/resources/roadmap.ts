const RoadMapContent = [
  ...
  },
  {
    ...
    state : "In progress",
    goal: " Enable a rent mechanism to facilitate larger cohesive displays without giving up ownership.",
    description: ''
  },
  {
    date: '03/20/2000',
  ...
  {
    date: '08/31/2002',
    title: 'The Extend revolution',
    state : "In progress",
    goal: "Take over the world.",
    description: 'Spaces become the new standard for NFT\'s on Solana. Future applications extend from Spaces.'
  }
];
